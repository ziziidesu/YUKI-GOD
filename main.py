...
ver = "2.5.3" # バージョン    
update = "動画のスキップ、巻き戻しの追加 サムネイル画像のダウンロードリンクの追加" # アップデート内容
token = "e4f5c13f-4f31-4ae1-ac5c-b3f1df232073" # hcaptchaのサイトキー
max_api_wait_time = 3
max_time = 10
apis = [r"https://invidious.private.coffee/",r"https://iv.datura.network/",r"https://invidious.fdn.fr/",r"https://invidious.perennialte.ch/",r"https://invidious.materialio.us/"]
